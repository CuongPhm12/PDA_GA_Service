...
{
    public class SQLHelper_17
    {
        public static string CONNECTION_STRINGS = "";
        public static void ConnectString(ConfigDatabase config)
        {
            CONNECTION_STRINGS = config.ConnectString_17();
        }

        public static string Insert<T>(T entityToInsert) where T : class
        {
            using (SqlConnection connection = new SqlConnection(SQLHelper_17.CONNECTION_STRINGS))
            {
                connection.Open();
                long num;
                try
        ...
        public static async Task<DataTable> ExecProcedureDataAsyncAsDataTable(
          ...
          object parametter = null)
        {
            DataTable dataTable = await SQLHelper_17.WithConnection<DataTable>((Func<IDbConnection, Task<DataTable>>)(async c =>
            {
                IDbConnection cnn = c;
                string sql = ProcedureName;
                object obj = parametter;
        ...
        public static async Task<IEnumerable<T>> ExecProcedureDataAsync<T>(
          ...
          object parametter = null)
        {
            IEnumerable<T> objs1 = await SQLHelper_17.WithConnection<IEnumerable<T>>((Func<IDbConnection, Task<IEnumerable<T>>>)(async c =>
            {
                IDbConnection cnn = c;
                string sql = ProcedureName;
                object obj = parametter;
        ...
        {
            int num1 = await SQLHelper_17.WithConnection<int>((Func<IDbConnection, Task<int>>)(async c =>
            {
                IDbConnection cnn = c;
                string sql = T_SQL;
                object obj = parametter;
